...
const CASE_STUDIES = {
  ...
  pilotCraft: {
    ...
    // discipline, and its willingness to rate something a poor fit. Content
    // is real — captured from the running app with the project's own
    // hand-authored demo/fixture data (evals/fixtures.ts, "canned responses
    // ... stand in for what Gemini would return, so the harness can run
    // without a live API key") standing in for a live Gemini call, since no
    // API key is available in this build environment. No invented numbers,
    // ratings, or copy — every value shown is verbatim from that file.
    media: {
      hero: {
        src: '/case-studies/pilotcraft/report-summary.png',
        width: 1632,
        height: 720,
        alt: 'PilotCraft’s generated report for a customer-support scenario: an AI Suitability rating of Strong, a one-line rationale, and a 72% readiness score with a listed priority gap.',
        label: 'What this shows',
        caption: 'A completed report for one of PilotCraft’s built-in sample scenarios — a rating, a plain rationale, and a readiness score with the specific gap holding it back, not just a bare number.',
      },
      afterApproach: {
      ...
      afterOutcome: {
        ...
        width: 1632,
        height: 416,
        alt: 'PilotCraft’s Stop / Revise / Scale criteria for a contract-review scenario rated a poor fit for AI, with a stop condition against letting AI make binding decisions.',
        label: 'What this proves',
        caption: 'A different scenario — reviewing legal contracts for liability — where the tool rated AI a poor fit and said so, down to a stop condition against letting it make binding decisions at all.',
      },
    },
    stack: [
