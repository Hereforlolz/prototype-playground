...
const HIGHLIGHTS = [
  ...
  },
  {
    ...
    blurb: 'A serverless dashboard — React, AWS Lambda (Python), DynamoDB, and Claude via Bedrock — that turns messy session notes into summaries and supportive, non-diagnostic insights for therapists. Piloted with a real practicing therapist using synthetic patient data only, since no authentication was implemented yet — a real lesson from a first hackathon, stated plainly rather than glossed over. Built for the AWS Lambda Hackathon.',
  },
  {
