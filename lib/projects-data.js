...
const HIGHLIGHTS = [
  ...
  },
  {
    ...
    blurb: 'An AWS-native pipeline exploring neighborhood-level energy orchestration — simulated smart-meter data flows through IoT ingestion, S3, and Lambda, SageMaker forecasts next-day usage, and Bedrock generates personalized, multilingual sustainability tips, all surfaced through an AWS Amplify web/mobile app. Built solo, deliberately prioritizing a working end-to-end pipeline over UI polish. Built for the AWS Breaking Barriers Virtual Challenge, aimed at cutting utility costs in underserved Missouri households.',
  },
  {
    ...
    // review.
    blurb: 'A serverless workflow that turns unstructured therapy-session notes into summaries and draft observations for therapist review. Built with React, AWS Lambda, DynamoDB, and Claude; tested by one practicing therapist using synthetic data.',
  },
  {
    ...
    blurb: 'An AI-adoption decision tool — takes a plain-language workplace problem and returns a structured suitability report (strong/conditional/poor) via Gemini, with evidence discipline (facts vs. assumptions vs. missing evidence), a phased pilot plan, and an explicit 0–100 readiness heuristic. 74 passing tests plus a live evaluation harness scoring real Gemini output against 7 deterministic checks. A personal tool, not a hackathon build — no live deployment exists yet.',
  },
  {
  ...
  },
  {
    ...
    blurb: 'Turns a mundane excuse into an absurd, over-the-top one — template-based by default, or bring your own OpenAI key for AI-generated excuses.',
  },
  {
    ...
    blurb: 'Drafts a TikTok script from a topic, optionally pulling real headlines via a News API key — bring your own AI provider key to generate the script itself.',
  },
  {
